...
size_t intersect_count(vector<long int> &nodes, vector<KMVSet<NodeID>*> &sets, size_t *counter) {
...
size_t OrderedCount(const Graph &g, float threshold_, int k_, std::string graphName, int threads) {
    ...
    std::cout << "RRR 4C KMV 4C_KMV " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << threshold << " " << k << " " << m << " " << pp_time << " " << alg_time << " " << pp_time + alg_time <<  " " << total << std::endl;
    ...
    std::cout << "SSS 4C KMV 4C_KMV " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << threshold << " " << k << " " << m << " " << approx_str_size << " " << initial_csr_size << " " << approx_str_size + initial_csr_size << " " << total << std::endl;
