...
int64_t OrderedCount(const Graph &g, float treshold, int k_, float tau, std::string graphName, int threads) {
    ...
    std::cout << "RRR JP-CN KMV JP-CN_KMV " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << treshold << " " << k << " " << m << " " << tau << " " << pp_time << " " << alg_time << " " << pp_time + alg_time <<  " " << total << std::endl;
    ...
    std::cout << "SSS JP-CN KMV JP-CN_KMV " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << treshold << " " << k << " " << m << " " << tau << " " << approx_str_size << " " << initial_csr_size << " " << approx_str_size + initial_csr_size << " " << total << std::endl;
